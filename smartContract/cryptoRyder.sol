...
contract RideSharing {
   ...
   function requestPayment(address _riderAddress) public {
    require(msg.sender != _riderAddress, "You can't request to yourself");
        require(books[_riderAddress].request == true, "You have already requested");
        books[_riderAddress].request = false;
   }
...
// Contract Address: 0x79c5523F8f07f098Bfa70aad6AE90B0237B9DA0c